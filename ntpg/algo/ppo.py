    ...
    def update(self, rollouts):
        ...
        for e in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                ...
                # print(list(self.actor_critic.base.actor.parameters()))
                # print([p.grad for p in list(self.actor_critic.base.actor.parameters())])
                self.optimizer.zero_grad()
                ppo_loss = value_loss * self.value_loss_coef + action_loss - \
                           dist_entropy * self.entropy_coef
                if self.regularize_lambda is not None:
                    ppo_loss = ppo_loss + self.regularize_lambda()
                ppo_loss.backward()
